...
#include "dhry.h"
// #include <time.h>   // add karl
#include <stdlib.h> // add karl
...
// Proc_2(One_Fifty *Int_Par_Ref);      // add karl
// Proc_1(REG Rec_Pointer Ptr_Val_Par); // add karl
